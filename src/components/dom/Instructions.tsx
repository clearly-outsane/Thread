...
export default function Instructions({ children }: { children: React.ReactNode }) {
  return (
    <div
      className='absolute top-16 left-1/2 max-w-lg -translate-x-1/2 transform rounded-lg bg-zinc-800 px-10 py-8 text-sm shadow-xl md:text-base'
